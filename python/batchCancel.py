...
parser.add_option("-j", "--jobId", dest="jobId", type="string",action="store",help="The jobId of the Job's thats being canceled")
...
resp = requests.post(options.hostUrl + '/ls/api/batch/cancel'.format(options.community), headers={'Authorization':'Bearer ' + accessToken}, data=parameters)
print resp.text